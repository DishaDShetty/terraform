...
# Use jq to extract the totalMonthlyCost value from the JSON file
totalMonthlyCost=$(jq -r '.totalMonthlyCost' infracost_output.json)

# Print the value without any additional text
